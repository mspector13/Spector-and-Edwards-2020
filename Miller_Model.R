#Dr. Luke Miller's adapted Webb Model (adapted from Webb et al. 1974 
...
#first time users (on Mac): ctrl + click then alt/option then select "copy FILE as pathname") 

mydata=read.xls("PI_PLS_3_18.xls", sheet = 3 )
#^reads in the xls file, calls the specific sheet)
